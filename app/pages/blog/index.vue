<template>
  <section class="blog">
    <div class="py-8 md:py-16 text-center">
      <h1 class="font-title text-4xl xl:text-5xl">Blog</h1>
        ...
        <div class="post">
          <nuxt-link :to="`/blog/${post.slug}`">
            <img
              :alt="post.title"
              class="w-full"
              :src="post.featuredImage || 'https://source.unsplash.com/random/640x340/?france'"
            />
            <div class="p-6 bg-white">
              ...
              <h6 class="text-blue-600 mt-4 font-medium">Læs mere</h6>
            </div>
          </nuxt-link>
        </div>
      </div>
